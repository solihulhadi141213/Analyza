...
function ShowData() {
    ...
    $.ajax({
        type   : 'POST',
        url    : '_Page/ReferensiBodySite/TabelBodySite.php',
        data   : ProsesFilter,
...
$(document).ready(function() {
    ...
    $('#KeywordBy').change(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiBodySite/FormFilter.php',
    ...
    $('#ModalTambah').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiBodySite/list_system.php',
            success     : function(data){
    ...
    $('#ProsesTambah').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/ReferensiBodySite/ProsesTambah.php',
            dataType : 'json',
            data     : ProsesTambah,
    ...
    $(document).on('click', '.modal_edit', function () {
        ...
        //tangkap data 'id_referensi_body_site' dan buat variabel
        var id_referensi_body_site   = $(this).data('id');
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiBodySite/FormEdit.php',
            data        : {id_referensi_body_site: id_referensi_body_site},
            success     : function(data){
                $('#FormEdit').html(data);
    ...
    $('#ProsesEdit').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/ReferensiBodySite/ProsesEdit.php',
            dataType : 'json',
            data     : ProsesEdit,
    ...
    $(document).on('click', '.modal_hapus', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiBodySite/FormHapus.php',
            data        : {id_referensi_body_site: id_referensi_body_site},
            success     : function(data){
                $('#FormHapus').html(data);
            }
    ...
    $('#ProsesHapus').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/ReferensiBodySite/ProsesHapus.php',
            dataType : 'json',
            data     : ProsesHapus,
