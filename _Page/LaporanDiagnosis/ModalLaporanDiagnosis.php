...
<div class="modal fade" id="ModalExport" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="_Page/LaporanDiagnosis/ProsesExport.php" method="GET" target="_blank">
                <div class="modal-header">
...
==========================================================================================
-->
<div class="modal fade" id="ModalRincianLaporanDiagnosis" tabindex="-1">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <form action="_Page/LaporanDiagnosis/ProsesExportRincian.php" method="GET" target="_blank">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12" id="FormRincianLaporanDiagnosis">
