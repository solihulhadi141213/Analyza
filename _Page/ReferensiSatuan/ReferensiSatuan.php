<?php
    ...
    $IjinAksesSaya=IjinAksesSaya($Conn,$SessionIdAccess,'vA2qgCIl2YHVsxGmocRcv5293dcXh5oDXVYt');
...
?>
    <div class="pagetitle">
        <h1>
            <a href="">
                <i class="bi bi-box"></i> Satuan / Unit</a>
            </a>
        </h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                <li class="breadcrumb-item active">Satuan / Unit</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <small>
                        Halaman ini digunakan untuk mengelola referensi Satuan / Unit. Informasi tersebut berguna pada saat mengisi kelengkapan informasi hasil pemeriksaan.
