...
function ShowData() {
    ...
    $.ajax({
        type   : 'POST',
        url    : '_Page/ReferensiSatuan/TabelSatuan.php',
        data   : ProsesFilter,
...
$(document).ready(function() {
    ...
    $('#KeywordBy').change(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiSatuan/FormFilter.php',
    ...
    $(document).on('click', '.modal_export', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiSatuan/FormExport.php',
            success     : function(data){
    ...
    $(document).on('click', '.modal_import', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiSatuan/FormImport.php',
            success     : function(data){
    ...
    $('#ProsesImport').on('submit', function (e) {
        ...
        $.ajax({
            url: '_Page/ReferensiSatuan/ProsesImport.php',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $('#ModalTambah').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiSatuan/list_system.php',
            success     : function(data){
    ...
    $('#ProsesTambah').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/ReferensiSatuan/ProsesTambah.php',
            dataType : 'json',
            data     : ProsesTambah,
    ...
    $(document).on('click', '.modal_edit', function () {
        ...
        var id_referensi_satuan   = $(this).data('id');
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiSatuan/FormEdit.php',
            data        : {id_referensi_satuan: id_referensi_satuan},
            success     : function(data){
                $('#FormEdit').html(data);
    ...
    $('#ProsesEdit').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/ReferensiSatuan/ProsesEdit.php',
            dataType : 'json',
            data     : ProsesEdit,
    ...
    $(document).on('click', '.modal_hapus', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiSatuan/FormHapus.php',
            data        : {id_referensi_satuan: id_referensi_satuan},
            success     : function(data){
                $('#FormHapus').html(data);
            }
    ...
    $('#ProsesHapus').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/ReferensiSatuan/ProsesHapus.php',
            dataType : 'json',
            data     : ProsesHapus,
