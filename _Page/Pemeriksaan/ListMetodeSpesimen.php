<?php
    ...
    while ($row = $result->fetch_assoc()) {
        $nama_metode_sample    = $row['nama_metode_sample'];
        $display_metode_sample = $row['display_metode_sample'];
        $code_metode_sample    = $row['code_metode_sample'];

        $data[] = [
            "id"      => $row['id_referensi_metode_sample'],
            "text"    => "$code_metode_sample - $nama_metode_sample ($display_metode_sample)",
