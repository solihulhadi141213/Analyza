<?php
    ...
    //Buat variabel 'id_observation' dan sanitasi
    ...
    $url_api = $url_api . '/fhir-r4/v1/Observation/'.$id_observation.'';
   ...
   // DECODE RESPONSE
    ...
    if ($http_code !== 200) {
        ...
        echo '
            <div class="alert alert-danger text-center">
                <small>Gagal mengirim Procedure ke SATUSEHAT! <br> Pesan : '.$http_code.'</small>
            </div>
        ';
        exit;
    }
