<?php
    ...
    //id_diagnostic_report wajib terisi
    ...
    //Buat variabel 'id_diagnostic_report' dan sanitasi
   ...
   // DECODE RESPONSE
    ...
    if ($http_code !== 200) {
        ...
        echo '
            <div class="alert alert-danger text-center">
                <small>Gagal mengirim Diagnostic Report ke SATUSEHAT! <br> Pesan : '.$http_code.'</small>
            </div>
        ';
        exit;
    }
