    ...
    echo '
        <div class="row mb-3">
            <div class="col-md-112">
                <label for="keterangan_edit"><small>Keterangan / Catatan Lainnya</small></label>
                <textarea class="form-control" name="keterangan" id="keterangan_editketerangan_edit">'.$keterangan.'</textarea>
            </div>
        </div>
    ';
?>