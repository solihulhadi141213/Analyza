<?php
    ...
    echo '
        <div class="row mb-2">
            <div class="col-12">
                <small><b>A. Informasi Spesimen</b></small>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4"><small>ID Lab</small></div>
        ...
        <div class="row mb-2">
            <div class="col-4"><small>ID SATUSEHAT</small></div>
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text text-grayish text-long">'.$id_speciment.'</small>
            </div>
        </div>
        <div class="row mb-2">
        ...
        <div class="row mb-2 mt-3">
            <div class="col-12">
                <small><b>B. Metode Pengambilan Spesimen</b></small>
            </div>
        </div>
        <div class="row mb-2">
        ...
        <div class="row mb-2">
            ...
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text text-grayish text-long">'.$bodysite_nama.'</small>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4"><small><i>Display</i></small></div>
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text text-grayish text-long"><i>'.$bodysite_display.'</i></small>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4"><small><i>Code</i></small></div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text text-grayish text-long">'.$bodysite_system.'</small>
            </div>
        </div>
        <div class="row mb-2 mt-3">
            <div class="col-12">
                <small><b>D. Kemasan Spesimen (<i>Container</i>)</b></small>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4"><small>Nama Kemasan</small></div>
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
        ...
        <div class="row mb-2 mt-3">
            <div class="col-12">
                <small><b>E. Jumlah Spesimen (<i>Quantity Value</i>)</b></small>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4"><small>Jumlah / Volume</small></div>
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text text-grayish text-long">'.$quantity_value.' '.$quantity_unit.'</small>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4"><small><i>Code</i></small></div>
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text text-grayish text-long">'.$quantity_code.'</small>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4"><small><i>System</i></small></div>
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text text-grayish text-long">'.$quantity_system.'</small>
            </div>
        </div>
        <div class="row mb-2 mt-3">
            <div class="col-12">
                <small><b>F. Petugas Pengambil Spesimen</b></small>
            </div>
        </div>
        <div class="row mb-2">
