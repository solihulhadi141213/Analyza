                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            <select name="OrderBy" id="OrderBy" class="form-control">
                                ...
                                <option value="nama_spesimen">Nama Spesimen</option>
                                <option value="display_spesimen">Display</option>
                                <option value="code_spesimen">Code</option>
                                <option value="system_spesimen">System</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesTambah" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-plus"></i> Tambah Jenis Spesimen</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="nama_spesimen">Nama Spesimen</label>
                            <input type="text" name="nama_spesimen" id="nama_spesimen" class="form-control" required>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="display_spesimen"><i>Display</i></label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="code_spesimen"><i>Code</i></label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="system_spesimen"><i>System</i></label>
                            <input type="url" name="system_spesimen" id="system_spesimen" class="form-control" list="list_system" placeholder="https://" required>
