                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            <select name="OrderBy" id="OrderBy" class="form-control">
                                ...
                                <option value="nama_metode_sample">Metode Spesimen</option>
                                <option value="display_metode_sample">Display</option>
                                <option value="code_metode_sample">Code</option>
                                <option value="system_metode_sample">System</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesTambah" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-plus"></i> Tambah Metode Spesimen</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="nama_metode_sample">Nama Metode Spesimen</label>
                            <input type="text" name="nama_metode_sample" id="nama_metode_sample" class="form-control" required>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="display_metode_sample"><i>Display</i></label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="code_metode_sample"><i>Code</i></label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="system_metode_sample"><i>System</i></label>
                            <input type="url" name="system_metode_sample" id="system_metode_sample" class="form-control" list="list_system" placeholder="https://" required>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesEdit" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-pencil"></i> Edit Pengambilan Spesimen</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesHapus" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-trash"></i> Hapus Metode Spesimen</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
