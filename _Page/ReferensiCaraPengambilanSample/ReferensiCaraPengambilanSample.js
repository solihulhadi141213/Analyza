...
function ShowData() {
    ...
    $.ajax({
        type   : 'POST',
        url    : '_Page/ReferensiCaraPengambilanSample/TabelMetodeSpesimen.php',
        data   : ProsesFilter,
...
$(document).ready(function() {
    ...
    $('#KeywordBy').change(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiCaraPengambilanSample/FormFilter.php',
    ...
    $('#ModalTambah').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiCaraPengambilanSample/list_system.php',
            success     : function(data){
    ...
    $('#ProsesTambah').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/ReferensiCaraPengambilanSample/ProsesTambah.php',
            dataType : 'json',
            data     : ProsesTambah,
    ...
    $(document).on('click', '.modal_edit', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiCaraPengambilanSample/FormEdit.php',
            data        : {id_referensi_metode_sample: id_referensi_metode_sample},
            success     : function(data){
                $('#FormEdit').html(data);
    ...
    $('#ProsesEdit').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/ReferensiCaraPengambilanSample/ProsesEdit.php',
            dataType : 'json',
            data     : ProsesEdit,
    ...
    $(document).on('click', '.modal_hapus', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/ReferensiCaraPengambilanSample/FormHapus.php',
            data        : {id_referensi_metode_sample: id_referensi_metode_sample},
            success     : function(data){
                $('#FormHapus').html(data);
            }
    ...
    $('#ProsesHapus').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/ReferensiCaraPengambilanSample/ProsesHapus.php',
            dataType : 'json',
            data     : ProsesHapus,
