...
?>
    <div class="pagetitle">
        <h1>
            <a href="">
                <i class="bi bi-box"></i> Metode Pengambilan Spesimen</a>
            </a>
        </h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                <li class="breadcrumb-item active">Metode Pengambilan Spesimen</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <small>
                        Halaman ini digunakan untuk mengelola referensi Metode / Cara Pengambilan Spesimen. Informasi tersebut berguna pada saat mengisi kelengkapan informasi spesimen.
